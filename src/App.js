      ...
      <main className="p-6 max-w-6xl mx-auto">
        ...
        <div className="bg-gray-800 p-6 rounded-2xl shadow mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <input placeholder="Product Name" className="bg-gray-700 text-white p-2 rounded-md" />
            <input placeholder="Price (USD or KRW)" className="bg-gray-700 text-white p-2 rounded-md" />
            <input placeholder="Size Options (e.g. M, L, XL)" className="bg-gray-700 text-white p-2 rounded-md" />
            <input placeholder="Image URL" className="bg-gray-700 text-white p-2 rounded-md" />
            <input placeholder="Description" className="bg-gray-700 text-white p-2 rounded-md col-span-1 md:col-span-2" />
          </div>
          <button className="mt-4 w-full bg-white text-black py-2 rounded-md">Submit Product</button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="bg-gray-900 border-none rounded-2xl shadow-md hover:shadow-lg transition"
            >
              <div className="p-4">
                <img
                ...
                <button className="w-full bg-white text-black py-2 rounded-md">Buy Now</button>
              </div>
            </div>
          ))}
        </div>
